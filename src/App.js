...
class App extends Component {
  ...
  onChangeInput = event => {
    ...
    const filteredList = trackList.filter(each =>
  ...
  deleteTrack = id => {
    ...
    const updatedList = trackList.filter(item => item.id !== id)
    this.setState({trackList: updatedList})
  }
      ...
      <div className="play-list-container">
        ...
        <div className="bottom-container">
          <div className="bottom-top">
            <h1 className="songs-playlists">Songs Playlists</h1>
